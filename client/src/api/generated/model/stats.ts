...
export interface Stats {
    /**
     * Indicates if there is a host currently.
     */
    'has_host'?: boolean;
    /**
     * The ID of the current host, if any.
     */
    'host_id'?: string;
    /**
     * Monotonically increasing control lease epoch used to reject stale input.
     */
    'epoch'?: number;
    /**
    ...
    'total_users'?: number;
    /**
     * The timestamp when the last user left, if any.
     */
    'last_user_left_at'?: string;
    /**
     * The total number of admins connected.
     */
    'total_admins'?: number;
    /**
     * The timestamp when the last admin left, if any.
     */
    'last_admin_left_at'?: string;
}
